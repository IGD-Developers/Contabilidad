...
public class RevertirComprobanteValidator : AbstractValidator<RevertirComprobanteRequest>
{
    public RevertirComprobanteValidator()
    {
        //RuleFor(x => x.Id).NotEmpty();
    }
}

public class RevertirComprobanteHandler : IRequestHandler<RevertirComprobanteRequest>
{
    private readonly CntContext context;
    private readonly IMapper mapper;
    private IInsertarConsecutivo insertarConsecutivo;

    public RevertirComprobanteHandler(CntContext context, IMapper mapper, IInsertarConsecutivo insertarConsecutivo)
    {
    ...
    public async Task<Unit> Handle(RevertirComprobanteRequest request, CancellationToken cancellationToken)
    {
