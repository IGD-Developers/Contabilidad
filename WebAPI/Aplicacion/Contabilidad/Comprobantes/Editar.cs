...
public class EditarComprobanteValidator : AbstractValidator<EditarComprobanteRequest>
{
    public EditarComprobanteValidator()
    {
...
public class EditarComprobanteHandler : IRequestHandler<EditarComprobanteRequest>
{
    private readonly CntContext context;
    private readonly IMapper _mapper;


    public EditarComprobanteHandler(CntContext context, IMapper mapper)
    {
    ...
    public async Task<Unit> Handle(EditarComprobanteRequest request, CancellationToken cancellationToken)
    {
