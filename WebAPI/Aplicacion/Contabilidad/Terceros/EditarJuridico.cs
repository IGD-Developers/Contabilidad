...
public class EditarJuridicoRequest : EditarJuridicoModel, IRequest { }

public class EditarJuridicoValidator : AbstractValidator<EditarJuridicoRequest>
{
    public EditarJuridicoValidator()
    {
...
public class EditarJuridicoHandler : Funciones, IRequestHandler<EditarJuridicoRequest>
{
    private readonly CntContext _context;
    private readonly IMapper _mapper;
    private readonly IFunciones _funciones;

    public EditarJuridicoHandler(CntContext context, IMapper mapper, IFunciones funciones)
    {
    ...
    public async Task<Unit> Handle(EditarJuridicoRequest request, CancellationToken cancellationToken)
    {
