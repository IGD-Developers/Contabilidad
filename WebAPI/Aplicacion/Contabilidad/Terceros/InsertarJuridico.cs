...
public class InsertarJuridicoRequest : InsertarJuridicoModel, IRequest { }

public class InsertarJuridicoValidator : AbstractValidator<InsertarJuridicoRequest>
{
    public InsertarJuridicoValidator()
    {
...
public class InsertarJuridicoHandler : Funciones, IRequestHandler<InsertarJuridicoRequest>
{
    ...
    public InsertarJuridicoHandler(CntContext context, IMapper mapper, IFunciones funciones)
    {
        _context = context;
        _mapper = mapper;
    ...
    public async Task<Unit> Handle(InsertarJuridicoRequest request, CancellationToken cancellationToken)
    {
